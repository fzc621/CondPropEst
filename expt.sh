...
# === ground truth power ===
ground_truth_dir="${expt_dir}/ground_truth_power"
# $python -m src.cal_prop -n 10 -m power "${ground_truth_dir}/para.dat" "${DATA_DIR}/set1bin.train.feat.txt" \
#   "${ground_truth_dir}/set1bin.train.prop.txt"
# $python -m src.cal_prop -n 10 -m power "${ground_truth_dir}/para.dat" "${DATA_DIR}/set1bin.test.feat.txt" \
#   "${ground_truth_dir}/set1bin.test.prop.txt"

# === ground truth exp ===
# ground_truth_dir="${expt_dir}/ground_truth_exp"
# $python -m src.cal_prop -n 10 -m exp "${ground_truth_dir}/para.dat" "${DATA_DIR}/set1bin.train.feat.txt" \
#   "${ground_truth_dir}/set1bin.train.prop.txt"
# $python -m src.cal_prop -n 10 -m exp "${ground_truth_dir}/para.dat" "${DATA_DIR}/set1bin.test.feat.txt" \
#   "${ground_truth_dir}/set1bin.test.prop.txt"
...
#   $python -m src.sim_click -s $sw "${expt_dir}/para.dat" "${DATA_DIR}/set1bin.train.txt" \
...
# === recover ===
model_dir="${res_dir}/recover_pow"
$python -m src.model.recover_pow -m 10 -d 10 ${NPY_DIR} ${model_dir}
$python -m src.model.recover_pow --test --gt_dir ${ground_truth_dir} ${NPY_DIR} ${model_dir}

# === recover exp ===
model_dir="${res_dir}/recover_exp"
# $python -m src.model.recover_exp -m 10 -d 10 ${NPY_DIR} ${model_dir}
# $python -m src.model.recover_exp --test --gt_dir ${ground_truth_dir} ${NPY_DIR} ${model_dir}

# === mlp ===
model_dir="${res_dir}/ann/mlp"
# $python -m src.model.ann -m 10 -d 10 mlp ${NPY_DIR} ${model_dir} --gt_dir ${ground_truth_dir}
